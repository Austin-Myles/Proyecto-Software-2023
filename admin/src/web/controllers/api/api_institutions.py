...
from src.schemas.institution_schema import institution_schema, many_institution_schema
...
def get(inst_id):
    ...
    Example URI GET https://admin-grupoXX.proyecto2023.unlp.edu.ar/api/institutions/1
    """
    institution = institution_dbo.get_by_id(inst_id)
    return make_response(
        jsonify(
            {
