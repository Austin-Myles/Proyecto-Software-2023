...
class ServiceRequestCreateForm(FlaskForm):
    ...
    description = TextAreaField("Descripción", validators=[DataRequired("Campo requerido")])
    status = SelectField("Estado", choices=request_choices, validators=[DataRequired("Campo requerido")])
