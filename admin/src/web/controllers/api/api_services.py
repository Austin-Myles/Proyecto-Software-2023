...
def services_search():
    ...
    Example URI: GET https://admin-grupoXX.proyecto2023.unlp.edu.ar/api/services/search?q=prueba&type=ANALISIS&page=1&per_page=10
    """
    ...
    services = service_dbo.full_text_search(
        q=q,
    ...
    services_list = get_services_schema.dump(services)
