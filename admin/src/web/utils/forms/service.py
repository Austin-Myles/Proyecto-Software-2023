...
class ServiceCreateForm(FlaskForm):
    ...
    description = StringField("Descripción", validators=[DataRequired("Campo requerido")])
    ...
    service_type = StringField("Tipo de Servicio", validators=[DataRequired("Campo requerido")])
